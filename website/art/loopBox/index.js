...
threejs.prototype.renderer = function renderer() {
	...
	// this.renderer.setClearColor( 'yellow' , 1 );
...
threejs.prototype.floor = function floor() {
	...
	var material = new THREE.MeshBasicMaterial( { /** color: 'rgba(255,1,255,1)' */ transparent: true, opacity: 0 } );
